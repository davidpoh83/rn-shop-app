...
import ProductsOverviewScreen, { screenOptions as productsOverviewScreenOptions } from '../screens/shop/ProductsOverview';
...
import UserProductsScreen, { screenOptions as userProductsScreenOptions } from '../screens/user/UserProducts';
    ...
    return (
        ...
        >
            <ShopDrawerNavigator.Screen
                ...
                options={{
                    drawerIcon: props => <Ionicons name={Platform.OS === 'android' ? 'md-cart' : 'ios-cart'}
                        size={23}
                        color={props.color}
                    />
                }}
            ...
            <ShopDrawerNavigator.Screen
                ...
                options={{
                    drawerIcon: props => <Ionicons name={Platform.OS === 'android' ? 'md-list' : 'ios-list'}
                        size={23}
                        color={props.color}
                    />
                }}
